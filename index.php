...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>MB</b>Agenda</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
        ...
        if(isset($_POST['btnlogin'])){
          ...
          try {
            ...
            <div class="alert alert-success"  role="alert">
              ...
              header("Refresh: 3, pages/index.php");
            }else{
      ...
      <p style="margin-top:20px; text-align:center" class="mb-0">
        <a href="registro.php" class="text-center">Cadastrar novo usuário</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
